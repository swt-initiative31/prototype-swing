...
//	int id;
	 ...
	 * the control is selected, by sending it one of the messages defined in the
...
//}
	...
	public void processEvent(AWTEvent e) {
		...
		case java.awt.event.ActionEvent.ACTION_PERFORMED:
			if ((style & SWT.RADIO) == 0 && (isAdjustingSelection || !hooks(SWT.Selection)))
				return;
			break;
	...
	public void setForeground(Color color) {
		...
		int pixel = (color != null) ? color.intHandle : -1;
		if (pixel == foreground)
			return;
		foreground = pixel;
		redraw();
